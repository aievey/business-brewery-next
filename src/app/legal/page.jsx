    ...
    <PageContainer>
      ...
      <div className="w-full rounded-2xl border border-stone-200 shadow md:w-8/10">
        <div className="space-y-4 p-4 text-stone-700 md:px-10">
          <Head className="text-xl font-bold tracking-wider">
          ...
          <Elaboration>
            ...
            <p className="">
              ...
              of the website development, software solutions, and related
              services (the "Services") provided by <b>Business Brewery</b>{" "}
              ("we," "us," or "our"). By engaging our Services, you ("the
            ...
            <div className="ml-4">
              ...
              <p>
                1.2. Any changes or additions to the defined scope ("Scope
                Creep") must be agreed upon in writing by both parties and may
                result in additional fees and adjusted timelines.
              </p>
            </div>
            <h2>
            ...
            <div className="ml-4">
              <p>
                2.1. You agree to provide all necessary content, materials,
                brand assets, logins, and information ("Client Materials") in a
                timely manner and in the formats we request.
              </p>
              <p>
                2.2. You warrant that you own or have the necessary rights to
                all Client Materials you provide and that they do not infringe
            ...
            <div className="ml-4">
              ...
              <p>
                3.2. Invoices are due within the net terms specified (e.g., Net
                7, Net 15). Late payments may incur interest charges of [e.g.,
                1.5%] per month or the maximum allowed by law.
              </p>
              <p>
                3.3. All fees are non-refundable once work has commenced, as our
                Services are customized and non-tangible. Refunds for deposits
                are subject to the <b>Refund Policy</b> linked below. We do not
                offer "money-back guarantees" on completed work.
              </p>
            </div>
            <h2 id="privacy">
            ...
            <div className="ml-4">
              ...
              <p>
                4.2. <b>Client Materials:</b> You retain ownership of your
                Client Materials.
              </p>
              <p>
                4.3. <b>Deliverables:</b> Upon receipt of full and final
                payment, we grant you a perpetual, worldwide, non-exclusive
                license to use the final delivered website, software, or code
            ...
            <div className="ml-4">
              ...
              <p>
                5.2. You are responsible for thoroughly reviewing all
                deliverables during designated approval stages. Your written
                approval constitutes acceptance that the deliverable meets the
            ...
            <div className="ml-4">
              ...
              <p>
                ...
                <b>
                  ...
                  FOR ANY CLAIM ARISING FROM THESE TERMS OR OUR SERVICES SHALL
                  BE LIMITED TO THE AMOUNT YOU PAID US FOR THE SPECIFIC SERVICE
              ...
              <p>
                ...
                (INCLUDING LOST PROFITS, DATA, OR BUSINESS OPPORTUNITIES), EVEN
            ...
            <div className="ml-4">
              ...
              <p>
                ...
                immediately due. Upon termination for our breach, we will refund
                a prorated portion of any prepaid, unearned fees.
              </p>
            </div>
            <h2>
            ...
            <div className="ml-4">
              <p>
                ...
                damages, or losses arising from: (a) your use of the
                Deliverables; (b) your breach of these Terms; or (c) your
                infringement of any third-party rights via your Client
                Materials.
              </p>
            </div>
            <h2>
            ...
            <div className="ml-4">
              <p>
                ...
                hosting, maintenance, security updates, and technical support
                are not part of the Services and may be offered under a separate
                agreement.
              </p>
            </div>
            <h2>
            ...
            <div className="ml-4">
              <p>
                11.1. Governing Law: These Terms shall be governed by the laws
                of
                <b> Dehradun, India</b>.
              </p>
              <p>
