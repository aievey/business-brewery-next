...
const Form = () => {
  return (
    <form className="w-full rounded-2xl">
      <fieldset className="rounded-2xl border-2 border-amber-100 p-6">
      ...
      <fieldset className="rounded-2xl border-2 border-amber-100 p-6">
        ...
        <textarea
          ...
          placeholder="Briefly describe your business, your goals for this website, and any
        specific features or pages you have in mind. The more detail, the better
        I can help!"
        />
      </fieldset>
